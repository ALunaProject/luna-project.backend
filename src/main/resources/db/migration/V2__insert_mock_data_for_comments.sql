...
INSERT INTO comments (id, content, user_id, post_id, creation_date) VALUES
    (UUID_TO_BIN('dddddddd-dddd-dddd-dddd-dddddddddddd'), 'Eu começaria por um RPG clássico. A história costuma prender bastante.', UUID_TO_BIN('11111111-1111-1111-1111-111111111111'), UUID_TO_BIN('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), '2026-09-01 09:15:00'),
    (UUID_TO_BIN('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee'), 'Um lançamento recente pode ser mais fácil para quem está começando.', UUID_TO_BIN('22222222-2222-2222-2222-222222222222'), UUID_TO_BIN('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), '2026-09-01 09:30:00'),
    (UUID_TO_BIN('ffffffff-ffff-ffff-ffff-ffffffffffff'), 'Depende do seu estilo: exploração, combate ou uma boa narrativa?', UUID_TO_BIN('33333333-3333-3333-3333-333333333333'), UUID_TO_BIN('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'), '2026-09-01 10:05:00'),
    (UUID_TO_BIN('44444444-4444-4444-4444-444444444444'), 'Gosto quando a pista tem mudanças de elevação e atalhos arriscados.', UUID_TO_BIN('22222222-2222-2222-2222-222222222222'), UUID_TO_BIN('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), '2026-09-05 14:00:00'),
    (UUID_TO_BIN('55555555-5555-5555-5555-555555555555'), 'Concordo, mas uma pista bonita também faz muita diferença.', UUID_TO_BIN('11111111-1111-1111-1111-111111111111'), UUID_TO_BIN('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), '2026-09-05 14:12:00'),
    (UUID_TO_BIN('66666666-6666-6666-6666-666666666666'), 'As melhores pistas equilibram velocidade, técnica e diversão.', UUID_TO_BIN('33333333-3333-3333-3333-333333333333'), UUID_TO_BIN('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'), '2026-09-05 14:30:00');
